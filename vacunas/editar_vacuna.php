<?php
    ...
    <section>
        ...
        <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" >
            ...
            <div>
                <?php if ($bandera_editar_vacuna){ ?>
                    <div class="alert alert-warning">
                        <strong>Actualizado!</strong>La Vacuna se a Actualizado Correctamente
                    </div>
                <?php } ?>
